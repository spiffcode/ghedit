define(["require", "exports", 'assert', 'vs/editor/common/core/position', 'vs/editor/common/core/range', 'vs/editor/common/model/textModel', 'vs/editor/common/editorCommon'], function (require, exports, assert, position_1, range_1, textModel_1, editorCommon_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    function testGuessIndentation(defaultInsertSpaces, defaultTabSize, expectedInsertSpaces, expectedTabSize, text, msg) {
        var m = new textModel_1.TextModel([], textModel_1.TextModel.toRawText(text.join('\n'), {
    ...
    suite('Editor Model - TextModel', function () {
        test('getValueLengthInRange', function () {
            var m = new textModel_1.TextModel([], textModel_1.TextModel.toRawText('My First Line\r\nMy Second Line\r\nMy Third Line', textModel_1.TextModel.DEFAULT_CREATION_OPTIONS));
            ...
            m = new textModel_1.TextModel([], textModel_1.TextModel.toRawText('My First Line\nMy Second Line\nMy Third Line', textModel_1.TextModel.DEFAULT_CREATION_OPTIONS));
            assert.equal(m.getValueLengthInRange(new range_1.Range(1, 1, 1, 1)), ''.length);
            assert.equal(m.getValueLengthInRange(new range_1.Range(1, 1, 1, 2)), 'M'.length);
            assert.equal(m.getValueLengthInRange(new range_1.Range(1, 2, 1, 3)), 'y'.length);
            assert.equal(m.getValueLengthInRange(new range_1.Range(1, 1, 1, 14)), 'My First Line'.length);
        ...
        test('modifyPosition', function () {
            var m = new textModel_1.TextModel([], textModel_1.TextModel.toRawText('line one\nline two', textModel_1.TextModel.DEFAULT_CREATION_OPTIONS));
            ...
            assert.deepEqual(m.modifyPosition(new position_1.Position(30, 1), 0), new position_1.Position(2, 1));
            ...
            assert.throws(function () { return m.modifyPosition(new position_1.Position(1, 2), 17); });
            assert.throws(function () { return m.modifyPosition(new position_1.Position(1, 2), 100); });
            assert.throws(function () { return m.modifyPosition(new position_1.Position(1, 2), -2); });
            assert.throws(function () { return m.modifyPosition(new position_1.Position(1, 2), -100); });
            assert.throws(function () { return m.modifyPosition(new position_1.Position(2, 2), -100); });
            assert.throws(function () { return m.modifyPosition(new position_1.Position(2, 9), -18); });
        });
        test('normalizeIndentation 1', function () {
            var model = new textModel_1.TextModel([], {
                length: 0,
                lines: [],
                BOM: '',
                EOL: '\n',
