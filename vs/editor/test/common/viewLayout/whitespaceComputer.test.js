define(["require", "exports", 'assert', 'vs/editor/common/viewLayout/whitespaceComputer'], function (require, exports, assert, whitespaceComputer_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('Editor ViewLayout - WhitespaceComputer', function () {
        test('WhitespaceComputer', function () {
            var whitespaceComputer = new whitespaceComputer_1.WhitespaceComputer();
        ...
        test('WhitespaceComputer findInsertionIndex', function () {
            ...
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 0, ordinals, 0), 0);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 1, ordinals, 0), 0);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 2, ordinals, 0), 0);
            arr = [1];
            ordinals = makeArray(arr.length, 0);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 0, ordinals, 0), 0);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 1, ordinals, 0), 1);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 2, ordinals, 0), 1);
            arr = [1, 3];
            ordinals = makeArray(arr.length, 0);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 0, ordinals, 0), 0);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 1, ordinals, 0), 1);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 2, ordinals, 0), 1);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 3, ordinals, 0), 2);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 4, ordinals, 0), 2);
            arr = [1, 3, 5];
            ordinals = makeArray(arr.length, 0);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 0, ordinals, 0), 0);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 1, ordinals, 0), 1);
            ...
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 3, ordinals, 0), 2);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 4, ordinals, 0), 2);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 5, ordinals, 0), 3);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 6, ordinals, 0), 3);
            arr = [1, 3, 5];
            ordinals = makeArray(arr.length, 3);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 0, ordinals, 0), 0);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 1, ordinals, 0), 0);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 2, ordinals, 0), 1);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 3, ordinals, 0), 1);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 4, ordinals, 0), 2);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 5, ordinals, 0), 2);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 6, ordinals, 0), 3);
            arr = [1, 3, 5, 7];
            ordinals = makeArray(arr.length, 0);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 0, ordinals, 0), 0);
            ...
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 5, ordinals, 0), 3);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 6, ordinals, 0), 3);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 7, ordinals, 0), 4);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 8, ordinals, 0), 4);
            arr = [1, 3, 5, 7, 9];
            ordinals = makeArray(arr.length, 0);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 0, ordinals, 0), 0);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 1, ordinals, 0), 1);
            ...
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 7, ordinals, 0), 4);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 8, ordinals, 0), 4);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 9, ordinals, 0), 5);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 10, ordinals, 0), 5);
            arr = [1, 3, 5, 7, 9, 11];
            ordinals = makeArray(arr.length, 0);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 0, ordinals, 0), 0);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 1, ordinals, 0), 1);
            ...
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 9, ordinals, 0), 5);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 10, ordinals, 0), 5);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 11, ordinals, 0), 6);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 12, ordinals, 0), 6);
            arr = [1, 3, 5, 7, 9, 11, 13];
            ordinals = makeArray(arr.length, 0);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 0, ordinals, 0), 0);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 1, ordinals, 0), 1);
            ...
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 11, ordinals, 0), 6);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 12, ordinals, 0), 6);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 13, ordinals, 0), 7);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 14, ordinals, 0), 7);
            ...
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 13, ordinals, 0), 7);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 14, ordinals, 0), 7);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 15, ordinals, 0), 8);
            assert.equal(whitespaceComputer_1.WhitespaceComputer.findInsertionIndex(arr, 16, ordinals, 0), 8);
        });
        test('WhitespaceComputer changeWhitespaceAfterLineNumber & getFirstWhitespaceIndexAfterLineNumber', function () {
            var whitespaceComputer = new whitespaceComputer_1.WhitespaceComputer();
