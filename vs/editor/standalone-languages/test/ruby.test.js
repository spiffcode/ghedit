 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", 'vs/editor/standalone-languages/ruby', 'vs/editor/standalone-languages/test/testUtil'], function (require, exports, ruby_1, testUtil_1) {
    'use strict';
    testUtil_1.testTokenization('ruby', ruby_1.language, [
        // Keywords
        [{
