 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", 'vs/editor/standalone-languages/bat', 'vs/editor/standalone-languages/test/testUtil'], function (require, exports, bat_1, testUtil_1) {
    'use strict';
    testUtil_1.testTokenization('bat', bat_1.language, [
        // support.functions
        [{
    ...
    testUtil_1.testOnEnter('bat', bat_1.language, function (assertOnEnter) {
