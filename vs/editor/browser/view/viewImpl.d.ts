...
export declare class View extends ViewEventHandler implements editorBrowser.IView, IDisposable {
    ...
    private _editorTextFocusContextKey;
    constructor(keybindingService: IKeybindingService, commandService: ICommandService, configuration: Configuration, model: IViewModel, triggerCursorHandler: TriggerCursorHandler);
    private _flushAnyAccumulatedEvents();
    private createTextArea(keybindingService);
    ...
    private _renderNow();
    private createRenderingContext(linesViewportData);
