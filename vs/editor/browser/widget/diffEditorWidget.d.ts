...
export declare class DiffEditorWidget extends EventEmitter implements editorBrowser.IDiffEditor {
    ...
    constructor(domElement: HTMLElement, options: editorCommon.IDiffEditorOptions, editorWorkerService: IEditorWorkerService, keybindingService: IKeybindingService, instantiationService: IInstantiationService);
