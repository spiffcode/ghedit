 ...
 */
export declare const KEYBINDING_CONTEXT_EDITOR_TEXT_FOCUS: string;
/**
 * A context key that is set when the editor's text or an editor's widget has focus.
 */
export declare const KEYBINDING_CONTEXT_EDITOR_FOCUS: string;
/**
 * @internal
 */
export declare const KEYBINDING_CONTEXT_EDITOR_TAB_MOVES_FOCUS: string;
/**
 * A context key that is set when the editor's text is readonly.
 */
export declare const KEYBINDING_CONTEXT_EDITOR_READONLY: string;
/**
 * A context key that is set when the editor has multiple selections (multiple cursors).
 */
export declare const KEYBINDING_CONTEXT_EDITOR_HAS_MULTIPLE_SELECTIONS: string;
/**
 * A context key that is set when the editor has a non-collapsed selection.
 */
export declare const KEYBINDING_CONTEXT_EDITOR_HAS_NON_EMPTY_SELECTION: string;
/**
 * A context key that is set to the language associated with the model associated with the editor.
 */
export declare const KEYBINDING_CONTEXT_EDITOR_LANGUAGE_ID: string;
/**
 * @internal
 */
export declare const SHOW_ACCESSIBILITY_HELP_ACTION_ID: string;
/**
 * @internal
 */
export declare namespace ModeContextKeys {
     ...
     * @internal
     */
    const hasCompletionItemProvider: string;
    /**
     * @internal
     */
    const hasCodeActionsProvider: string;
    /**
     * @internal
     */
    const hasCodeLensProvider: string;
    /**
     * @internal
     */
    const hasDefinitionProvider: string;
    /**
     * @internal
     */
    const hasHoverProvider: string;
    /**
     * @internal
     */
    const hasDocumentHighlightProvider: string;
    /**
     * @internal
     */
    const hasDocumentSymbolProvider: string;
    /**
     * @internal
     */
    const hasReferenceProvider: string;
    /**
     * @internal
     */
    const hasRenameProvider: string;
    /**
     * @internal
     */
    const hasFormattingProvider: string;
    /**
     * @internal
     */
    const hasSignatureHelpProvider: string;
}
 ...
 * @internal
 */
export declare var ViewEventNames: {
    ModelFlushedEvent: string;
    LinesDeletedEvent: string;
    LinesInsertedEvent: string;
    LineChangedEvent: string;
 ...
 * @internal
 */
export declare type IEditorActionContributionCtor = IConstructorSignature2<IEditorActionDescriptorData, ICommonCodeEditor, IEditorContribution>;
/**
 * @internal
 */
