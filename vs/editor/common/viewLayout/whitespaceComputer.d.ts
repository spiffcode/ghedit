...
export declare class WhitespaceComputer {
    ...
    private insertWhitespaceAtIndex(id, insertIndex, afterLineNumber, ordinal, heightInPx);
    ...
    private removeWhitespaceAtIndex(removeIndex);
    /**
    ...
    private findLastWhitespaceBeforeLineNumber(lineNumber);
    private findFirstWhitespaceAfterLineNumber(lineNumber);
    /**
