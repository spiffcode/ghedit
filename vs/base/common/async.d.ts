...
export declare function asWinJsPromise<T>(callback: (token: CancellationToken) => T | Thenable<T>): TPromise<T>;
/**
 * Hook a cancellation token to a WinJS Promise
 */
export declare function wireCancellationToken<T>(token: CancellationToken, promise: TPromise<T>): Thenable<T>;
 ...
 */
export declare function sequence<T>(promiseFactory: ITask<TPromise<T>>[]): TPromise<T[]>;
