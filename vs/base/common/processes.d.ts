...
import { ValidationStatus, ILogger, Parser, ISystemVariables } from 'vs/base/common/parsers';
/**
...
export declare function resolveCommandOptions(options: CommandOptions, variables: ISystemVariables): CommandOptions;
export declare function resolveExecutable(executable: Executable, variables: ISystemVariables): Executable;
