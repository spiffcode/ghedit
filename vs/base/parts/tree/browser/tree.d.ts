...
export declare var DRAG_OVER_REJECT: IDragOverReaction;
export declare var DRAG_OVER_ACCEPT: IDragOverReaction;
export declare var DRAG_OVER_ACCEPT_BUBBLE_UP: IDragOverReaction;
export declare var DRAG_OVER_ACCEPT_BUBBLE_DOWN: IDragOverReaction;
export declare var DRAG_OVER_ACCEPT_BUBBLE_UP_COPY: IDragOverReaction;
export declare var DRAG_OVER_ACCEPT_BUBBLE_DOWN_COPY: IDragOverReaction;
