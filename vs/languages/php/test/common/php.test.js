...
define(["require", "exports", 'vs/editor/test/common/modesUtil', 'vs/languages/html/common/html', 'vs/editor/test/common/mocks/mockModeService', 'vs/platform/test/common/nullThreadService', 'vs/platform/thread/common/thread', 'vs/editor/common/services/modeService', 'vs/platform/instantiation/common/serviceCollection', 'vs/platform/instantiation/common/instantiationService', 'vs/languages/php/common/php', 'vs/editor/test/common/mocks/mockMode'], function (require, exports, modesUtil, html_1, mockModeService_1, nullThreadService_1, thread_1, modeService_1, serviceCollection_1, instantiationService_1, php_1, mockMode_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
    'use strict';
    var PHPMockModeService = (function (_super) {
        __extends(PHPMockModeService, _super);
        function PHPMockModeService() {
            _super.call(this);
            this._htmlMode = null;
        }
        PHPMockModeService.prototype.setHTMLMode = function (htmlMode) {
            this._htmlMode = htmlMode;
        };
        PHPMockModeService.prototype.getMode = function (commaSeparatedMimetypesOrCommaSeparatedIds) {
    ...
    suite('Syntax Highlighting - PHP', function () {
        ...
        (function () {
            ...
            var modeService = new PHPMockModeService();
            ...
            modeService.setHTMLMode(new html_1.HTMLMode({ id: 'html' }, inst, modeService, threadService));
            var mode = new php_1.PHPMode({ id: 'php' }, modeService, null);
            ...
            modesUtil.executeTests(tokenizationSupport, [
                ...
                [{
                        ...
                        tokens: [
                            ...
                            { startIndex: 13, type: 'metatag.php' },
                            { startIndex: 15, type: html_1.htmlTokenTypes.DELIM_START },
                ...
                [{
                        ...
                        tokens: [
                            ...
                            { startIndex: 46, type: html_1.htmlTokenTypes.DELIM_START }
                        ] }],
                // html/js/php/js/
                [{
                        ...
                        tokens: [
                            ...
                            { startIndex: 49, type: html_1.htmlTokenTypes.DELIM_START },
                            { startIndex: 50, type: 'mock-js' },
                            { startIndex: 60, type: html_1.htmlTokenTypes.DELIM_END },
                            { startIndex: 62, type: html_1.htmlTokenTypes.getTag('script') },
                            { startIndex: 68, type: html_1.htmlTokenTypes.DELIM_END }
                        ] }],
                // Multiline test
                [{
                        line: '<html>',
                        ...
                        tokens: [
                            ...
                            { startIndex: 6, type: html_1.htmlTokenTypes.DELIM_START },
                            { startIndex: 7, type: 'metatag.php' },
                            { startIndex: 10, type: 'string.php' },
                            { startIndex: 15, type: 'metatag.php' },
                            { startIndex: 17, type: 'mock-css' },
                            { startIndex: 32, type: html_1.htmlTokenTypes.DELIM_END },
                            { startIndex: 34, type: html_1.htmlTokenTypes.getTag('style') },
                            { startIndex: 39, type: html_1.htmlTokenTypes.DELIM_END }
                        ] }, {
                        line: '<style><?="div"?>{ color:blue; }</style>',
                        tokens: [
                            { startIndex: 0, type: html_1.htmlTokenTypes.DELIM_START },
                ...
                [{
                        ...
                        tokens: [
                            ...
                            { startIndex: 46, type: html_1.htmlTokenTypes.DELIM_END },
                            { startIndex: 47, type: html_1.htmlTokenTypes.DELIM_COMMENT },
                            { startIndex: 51, type: 'metatag.php' },
                            { startIndex: 54, type: 'string.php' },
                            { startIndex: 68, type: 'metatag.php' },
                            { startIndex: 70, type: html_1.htmlTokenTypes.DELIM_COMMENT },
                            { startIndex: 73, type: html_1.htmlTokenTypes.DELIM_START },
                            { startIndex: 74, type: html_1.htmlTokenTypes.getTag('script') },
                            { startIndex: 80, type: html_1.htmlTokenTypes.DELIM_START },
                            ...
                            { startIndex: 137, type: html_1.htmlTokenTypes.DELIM_END },
                            { startIndex: 139, type: html_1.htmlTokenTypes.getTag('script') },
                            { startIndex: 145, type: html_1.htmlTokenTypes.DELIM_END },
                            { startIndex: 146, type: html_1.htmlTokenTypes.DELIM_END },
                            { startIndex: 148, type: html_1.htmlTokenTypes.getTag('html') },
                            { startIndex: 152, type: html_1.htmlTokenTypes.DELIM_END },
                ...
                [{
                        line: '<!--c--><?',
                        tokens: [
                            { startIndex: 0, type: html_1.htmlTokenTypes.DELIM_COMMENT },
                            { startIndex: 4, type: html_1.htmlTokenTypes.COMMENT },
                            { startIndex: 5, type: html_1.htmlTokenTypes.DELIM_COMMENT },
                            { startIndex: 8, type: 'metatag.php' }
                        ] }],
                [{
                        line: '<script>//<?',
