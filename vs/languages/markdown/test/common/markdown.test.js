...
define(["require", "exports", 'vs/editor/test/common/modesUtil', 'vs/languages/html/common/html', 'vs/editor/test/common/mocks/mockModeService', 'vs/platform/test/common/nullThreadService', 'vs/platform/thread/common/thread', 'vs/editor/common/services/modeService', 'vs/platform/instantiation/common/serviceCollection', 'vs/platform/instantiation/common/instantiationService', 'vs/languages/markdown/common/markdown', 'vs/editor/test/common/mocks/mockMode'], function (require, exports, modesUtil, html_1, mockModeService_1, nullThreadService_1, thread_1, modeService_1, serviceCollection_1, instantiationService_1, markdown_1, mockMode_1) {
    /*---------------------------------------------------------------------------------------------
