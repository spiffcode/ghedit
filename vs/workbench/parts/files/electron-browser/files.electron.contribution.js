...
define(["require", "exports", 'vs/nls', 'vs/platform/platform', 'vs/workbench/browser/actionBarRegistry', 'vs/workbench/common/actionRegistry', 'vs/platform/actions/common/actions', 'vs/base/common/platform', 'vs/workbench/parts/files/common/files', 'vs/workbench/common/contributions', 'vs/workbench/parts/files/browser/fileActions', 'vs/workbench/parts/files/electron-browser/electronFileTracker', 'vs/workbench/parts/files/electron-browser/textFileServices', 'vs/workbench/parts/files/electron-browser/electronFileActions', 'vs/platform/instantiation/common/instantiation', 'vs/platform/instantiation/common/extensions', 'vs/base/common/keyCodes'], function (require, exports, nls, platform_1, actionBarRegistry_1, actionRegistry_1, actions_1, env, files_1, contributions_1, fileActions_1, electronFileTracker_1, textFileServices_1, electronFileActions_1, instantiation_1, extensions_1, keyCodes_1) {
    ...
    workbenchActionsRegistry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(fileActions_1.SaveFileAsAction, fileActions_1.SaveFileAsAction.ID, fileActions_1.SaveFileAsAction.LABEL, { primary: keyCodes_1.KeyMod.CtrlCmd | keyCodes_1.KeyMod.Shift | keyCodes_1.KeyCode.KEY_S }), 'Files: Save As...', category);
    workbenchActionsRegistry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(fileActions_1.GlobalNewUntitledFileAction, fileActions_1.GlobalNewUntitledFileAction.ID, fileActions_1.GlobalNewUntitledFileAction.LABEL, { primary: keyCodes_1.KeyMod.CtrlCmd | keyCodes_1.KeyCode.KEY_N }), 'Files: New Untitled File', category);
    workbenchActionsRegistry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(electronFileActions_1.GlobalCopyPathAction, electronFileActions_1.GlobalCopyPathAction.ID, electronFileActions_1.GlobalCopyPathAction.LABEL, { primary: keyCodes_1.KeyMod.chord(keyCodes_1.KeyMod.CtrlCmd | keyCodes_1.KeyCode.KEY_K, keyCodes_1.KeyCode.KEY_P) }), 'Files: Copy Path of Active File', category);
    workbenchActionsRegistry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(electronFileActions_1.GlobalRevealInOSAction, electronFileActions_1.GlobalRevealInOSAction.ID, electronFileActions_1.GlobalRevealInOSAction.LABEL, { primary: keyCodes_1.KeyMod.chord(keyCodes_1.KeyMod.CtrlCmd | keyCodes_1.KeyCode.KEY_K, keyCodes_1.KeyCode.KEY_R) }), 'Files: Reveal Active File', category);
    workbenchActionsRegistry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(electronFileActions_1.ShowOpenedFileInNewWindow, electronFileActions_1.ShowOpenedFileInNewWindow.ID, electronFileActions_1.ShowOpenedFileInNewWindow.LABEL, { primary: keyCodes_1.KeyMod.chord(keyCodes_1.KeyMod.CtrlCmd | keyCodes_1.KeyCode.KEY_K, keyCodes_1.KeyCode.KEY_O) }), 'Files: Open Active File in New Window', category);
    if (env.isMacintosh) {
        workbenchActionsRegistry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(electronFileActions_1.OpenFileFolderAction, electronFileActions_1.OPEN_FILE_FOLDER_ID, electronFileActions_1.OPEN_FILE_FOLDER_LABEL, { primary: keyCodes_1.KeyMod.CtrlCmd | keyCodes_1.KeyCode.KEY_O }), 'Files: Open...', category);
    }
    else {
        workbenchActionsRegistry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(electronFileActions_1.OpenFileAction, electronFileActions_1.OPEN_FILE_ID, electronFileActions_1.OPEN_FILE_LABEL, { primary: keyCodes_1.KeyMod.CtrlCmd | keyCodes_1.KeyCode.KEY_O }), 'Files: Open File...', category);
        workbenchActionsRegistry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(electronFileActions_1.OpenFolderAction, electronFileActions_1.OPEN_FOLDER_ID, electronFileActions_1.OPEN_FOLDER_LABEL), 'Files: Open Folder...', category);
    }
