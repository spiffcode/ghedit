define(["require", "exports", 'vs/nls', 'vs/platform/keybinding/common/keybindingsRegistry', 'vs/platform/instantiation/common/instantiation', 'vs/workbench/services/editor/common/editorService', 'vs/base/common/uri', '../common/htmlInput', 'vs/workbench/parts/html/browser/htmlPreviewPart', 'vs/platform/platform', 'vs/workbench/browser/parts/editor/baseEditor', 'vs/platform/instantiation/common/descriptors'], function (require, exports, nls_1, keybindingsRegistry_1, instantiation_1, editorService_1, uri_1, htmlInput_1, htmlPreviewPart_1, platform_1, baseEditor_1, descriptors_1) {
    ...
    'use strict';
    // --- Register Editor
    platform_1.Registry.as(baseEditor_1.Extensions.Editors).registerEditor(new baseEditor_1.EditorDescriptor(htmlPreviewPart_1.HtmlPreviewPart.ID, nls_1.localize('html.editor.label', "Html Preview"), 'vs/workbench/parts/html/browser/htmlPreviewPart', 'HtmlPreviewPart'), [new descriptors_1.SyncDescriptor(htmlInput_1.HtmlInput)]);
    // --- Register Commands
