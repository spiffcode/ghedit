...
export declare const REPL_ID: string;
export declare const DEBUG_SERVICE_ID: string;
export declare const CONTEXT_IN_DEBUG_MODE: string;
export declare const EDITOR_CONTRIBUTION_ID: string;
...
export interface IViewModel extends ITreeElement {
    ...
    setSelectedExpression(expression: IExpression): any;
...
export declare const IDebugService: {
    (...args: any[]): void;
    type: IDebugService;
};
