...
export declare abstract class CompositePart<T extends Composite> extends Part {
    ...
    private activeCompositeListeners;
    ...
    constructor(messageService: IMessageService, storageService: IStorageService, eventService: IEventService, telemetryService: ITelemetryService, contextMenuService: IContextMenuService, partService: IPartService, keybindingService: IKeybindingService, instantiationService: IInstantiationService, registry: CompositeRegistry<T>, activeCompositeSettingsKey: string, nameForTelemetry: string, compositeCSSClass: string, actionContributionScope: string, id: string);
