...
// Forked from vs/workbench/electron-browser/workbench.ts

import 'vs/css!vs/workbench/electron-browser/media/workbench' // Was vs/css!./media/workbench';
...
import {EditorPart} from 'forked/editorPart';
