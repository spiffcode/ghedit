...
// Forked from vs/workbench/parts/search/browser/searchResultsView.ts
...
import { SearchViewlet } from 'forked/searchViewlet';
import { RemoveAction, ReplaceAllAction, ReplaceAction } from 'forked/searchActions';
