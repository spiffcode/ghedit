 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", 'vs/base/common/timer', 'vs/base/common/lifecycle', 'vs/base/browser/dom', 'vs/css!./timer'], function (require, exports, timer_1, lifecycle_1, DomUtils) {
    'use strict';
    var TimeKeeperRenderer = (function () {
        function TimeKeeperRenderer(onHide) {
            var _this = this;
            this.timeKeeper = timer_1.getTimeKeeper();
            this.onHide = onHide;
        ...
        TimeKeeperRenderer.prototype._createDomNode = function () {
            ...
            cancel.type = 'button';
            cancel.value = 'Clear';
            this.listenersToRemove.push(DomUtils.addDisposableListener(cancel, 'click', function () { return _this._onClear(); }));
            ...
            this.listenersToRemove.push(DomUtils.addDisposableListener(this.textFilterDomNode, 'keydown', function () { return _this.onTextFilterChange(); }));
            this.textFilter = '';
            ...
            this.listenersToRemove.push(DomUtils.addDisposableListener(this.timeFilterDomNode, 'keydown', function () { return _this.onTimeFilterChange(); }));
            this.timeFilter = 0;
            ...
            hide.type = 'button';
            hide.value = 'Close';
            this.listenersToRemove.push(DomUtils.addDisposableListener(hide, 'click', function () {
                _this.onHide();
            }));
        ...
        TimeKeeperRenderer.prototype.refilter = function () {
            ...
            for (var i = 0; i < domNodes.length; i++) {
                ...
                var event_1 = this.renderedEvents[eventId];
                if (this.shouldShow(event_1)) {
        ...
        TimeKeeperRenderer.prototype._renderEvent = function (domNode, event) {
            var start = event.startTime.getTime() - timer_1.TimeKeeper.PARSE_TIME.getTime();
