 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", 'vs/base/common/winjs.base', 'vs/base/common/assert', 'vs/base/browser/browser', 'vs/base/browser/builder', 'vs/base/browser/dom', 'vs/base/common/uuid', 'vs/base/common/lifecycle', 'vs/css!./progressbar'], function (require, exports, winjs_base_1, assert, browser, builder_1, DOM, uuid, lifecycle_1) {
    'use strict';
    var css_done = 'done';
