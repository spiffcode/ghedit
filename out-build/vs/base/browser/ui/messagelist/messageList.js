    ...
    var MessageList = (function () {
        ...
        MessageList.prototype.showMessage = function (severity, message) {
            ...
            if (Array.isArray(message)) {
                var closeFns_1 = [];
                message.forEach(function (msg) { return closeFns_1.push(_this.showMessage(severity, msg)); });
        ...
        MessageList.prototype.renderMessage = function (message, container, total, delta) {
            ...
            container.li({ class: 'message-list-entry message-list-entry-with-action' }, function (li) {
                ...
                li.div({ class: 'actions-container' }, function (actionContainer) {
                        ...
                        actionContainer.div({ class: 'message-action' }, function (div) {
                            div.a({ class: 'action-button', tabindex: '0', role: 'button' }).text(action.label).on([DOM.EventType.CLICK, DOM.EventType.KEY_DOWN], function (e) {
                                if (e instanceof KeyboardEvent) {
                                    ...
                                    if (!event_2.equals(keyCodes_1.CommonKeybindings.ENTER) && !event_2.equals(keyCodes_1.CommonKeybindings.SPACE)) {
                    ...
                    for (var i = messageActions.length - 1; i >= 0; i--) {
                        _loop_1(i);
                    }
                });
                // Text
