...
define(["require", "exports", 'vs/base/browser/dom', 'vs/base/browser/mouseEvent', 'vs/base/browser/touch', 'vs/editor/browser/controller/mouseHandler'], function (require, exports, dom, mouseEvent_1, touch_1, mouseHandler_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var TouchHandler = (function (_super) {
        ...
        function TouchHandler(context, viewController, viewHelper) {
            ...
            this.listenersToRemove.push(dom.addDisposableListener(this.viewHelper.linesContentDomNode, touch_1.EventType.Contextmenu, function (e) { return _this._onContextMenu(e, false); }));
        }
        ...
        TouchHandler.prototype.onTap = function (event) {
            ...
            this.viewHelper.focusTextArea();
            var mouseEvent = new mouseEvent_1.StandardMouseEvent(event);
