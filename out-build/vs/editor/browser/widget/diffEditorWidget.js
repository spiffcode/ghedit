...
define(["require", "exports", 'vs/base/common/async', 'vs/base/common/eventEmitter', 'vs/base/common/lifecycle', 'vs/base/common/objects', 'vs/base/browser/dom', 'vs/base/browser/styleMutator', 'vs/base/browser/ui/sash/sash', 'vs/platform/instantiation/common/instantiation', 'vs/editor/common/config/defaultConfig', 'vs/editor/common/core/range', 'vs/editor/common/editorCommon', 'vs/editor/common/services/editorWorkerService', 'vs/editor/common/viewLayout/viewLineParts', 'vs/editor/common/viewLayout/viewLineRenderer', 'vs/editor/browser/editorBrowser', 'vs/editor/browser/widget/codeEditorWidget', 'vs/css!./media/diffEditor'], function (require, exports, async_1, eventEmitter_1, lifecycle_1, objects, dom, styleMutator_1, sash_1, instantiation_1, defaultConfig_1, range_1, editorCommon, editorWorkerService_1, viewLineParts_1, viewLineRenderer_1, editorBrowser, codeEditorWidget_1) {
    'use strict';
    ...
    var DiffEditorWidget = (function (_super) {
        ...
        DiffEditorWidget.prototype._beginUpdateDecorations = function () {
            ...
            this._editorWorkerService.computeDiff(currentOriginalModel.getAssociatedResource(), currentModifiedModel.getAssociatedResource(), this._ignoreTrimWhitespace).then(function (result) {
    ...
    var DiffEdtorWidgetSideBySide = (function (_super) {
        ...
        function DiffEdtorWidgetSideBySide(dataSource, enableSplitViewResizing) {
            ...
            this._sash.on('start', function () { return _this.onSashDragStart(); });
            this._sash.on('change', function (e) { return _this.onSashDrag(e); });
            this._sash.on('end', function () { return _this.onSashDragEnd(); });
            this._sash.on('reset', function () { return _this.onSashReset(); });
        }
        ...
        DiffEdtorWidgetSideBySide.prototype._getOriginalEditorDecorations = function (lineChanges, ignoreTrimWhitespace, originalEditor, modifiedEditor) {
            ...
            for (i = 0, length = lineChanges.length; i < length; i++) {
                ...
                if (isChangeOrDelete(lineChange)) {
                    ...
                    result.overviewZones.push(new editorBrowser.OverviewRulerZone(lineChange.originalStartLineNumber, lineChange.originalEndLineNumber, editorCommon.OverviewRulerLane.Full, 0, 'rgba(255, 0, 0, 0.4)', 'rgba(255, 0, 0, 0.4)'));
        ...
        DiffEdtorWidgetSideBySide.prototype._getModifiedEditorDecorations = function (lineChanges, ignoreTrimWhitespace, originalEditor, modifiedEditor) {
            ...
            for (i = 0, length = lineChanges.length; i < length; i++) {
                ...
                if (isChangeOrInsert(lineChange)) {
                    ...
                    result.overviewZones.push(new editorBrowser.OverviewRulerZone(lineChange.modifiedStartLineNumber, lineChange.modifiedEndLineNumber, editorCommon.OverviewRulerLane.Full, 0, 'rgba(155, 185, 85, 0.4)', 'rgba(155, 185, 85, 0.4)'));
                    if (lineChange.charChanges) {
                        for (j = 0, lengthJ = lineChange.charChanges.length; j < lengthJ; j++) {
                            charChange = lineChange.charChanges[j];
    ...
    var InlineViewZonesComputer = (function (_super) {
        ...
        InlineViewZonesComputer.prototype.renderOriginalLine = function (count, originalModel, config, tabSize, lineNumber, decorations) {
            ...
            var lineTokens = new editorCommon.ViewLineTokens([new editorCommon.ViewLineToken(0, '')], 0, lineContent.length);
            var parts = viewLineParts_1.createLineParts(lineNumber, 1, lineContent, tabSize, lineTokens, decorations, config.renderWhitespace, config.indentGuides);
            var r = viewLineRenderer_1.renderLine(new viewLineRenderer_1.RenderLineInput(lineContent, tabSize, config.spaceWidth, config.stopRenderingLineAfter, config.renderWhitespace, parts.getParts()));
            var myResult = [];
