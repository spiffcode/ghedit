 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", 'vs/editor/standalone-languages/coffee', 'vs/editor/standalone-languages/test/testUtil'], function (require, exports, coffee_1, testUtil_1) {
    'use strict';
    testUtil_1.testOnEnter('coffeescript', coffee_1.language, function (assertOnEnter) {
    ...
    testUtil_1.testTokenization('coffeescript', coffee_1.language, [
        // Comments
        [{
                line: '#',
                tokens: [
