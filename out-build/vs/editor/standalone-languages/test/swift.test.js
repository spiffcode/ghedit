 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", 'vs/editor/standalone-languages/swift', 'vs/editor/standalone-languages/test/testUtil'], function (require, exports, swift_1, testUtil_1) {
    'use strict';
    testUtil_1.testTokenization('swift', swift_1.language, [
        // Attributes
        [{
                line: '@noescape',
                tokens: [
