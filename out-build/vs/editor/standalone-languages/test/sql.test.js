 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", 'vs/editor/standalone-languages/sql', 'vs/editor/standalone-languages/test/testUtil'], function (require, exports, sql_1, testUtil_1) {
    'use strict';
    testUtil_1.testTokenization('sql', sql_1.language, [
        // Comments
        [{
                line: '-- a comment',
                tokens: [
