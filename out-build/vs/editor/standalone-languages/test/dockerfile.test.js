 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", 'vs/editor/standalone-languages/dockerfile', 'vs/editor/standalone-languages/test/testUtil'], function (require, exports, dockerfile_1, testUtil_1) {
    'use strict';
    testUtil_1.testTokenization('dockerfile', dockerfile_1.language, [
        // All
        [{
                line: 'FROM mono:3.12',
                tokens: [
