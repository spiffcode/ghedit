 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", 'vs/editor/standalone-languages/jade', 'vs/editor/standalone-languages/test/testUtil'], function (require, exports, jade_1, testUtil_1) {
    'use strict';
    testUtil_1.testTokenization('jade', jade_1.language, [
        // Tags [Jade]
        [{
                line: 'p 5',
                tokens: [
