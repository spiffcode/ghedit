 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", 'assert', 'vs/editor/standalone-languages/powershell', 'vs/editor/standalone-languages/test/testUtil'], function (require, exports, assert, powershell_1, testUtil_1) {
    'use strict';
    testUtil_1.testTokenization('powershell', powershell_1.language, [
    ...
    suite('powershell', function () {
        test('word definition', function () {
            var wordDefinition = powershell_1.language.wordDefinition;
