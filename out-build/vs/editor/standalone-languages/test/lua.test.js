 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", 'vs/editor/standalone-languages/lua', 'vs/editor/standalone-languages/test/testUtil'], function (require, exports, lua_1, testUtil_1) {
    'use strict';
    testUtil_1.testTokenization('lua', lua_1.language, [
        // Keywords
        [{
                line: 'local x, y = 1, 10',
                tokens: [
