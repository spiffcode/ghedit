 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", 'vs/editor/standalone-languages/r', 'vs/editor/standalone-languages/test/testUtil'], function (require, exports, r_1, testUtil_1) {
    'use strict';
    testUtil_1.testTokenization('r', r_1.language, [
        // Keywords
        [{
                line: 'function(a) { a }',
                tokens: [
