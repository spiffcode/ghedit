 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", 'vs/editor/standalone-languages/python', 'vs/editor/standalone-languages/test/testUtil'], function (require, exports, python_1, testUtil_1) {
    'use strict';
    testUtil_1.testTokenization('python', python_1.language, [
        // Keywords
        [{
                line: 'def func():',
                tokens: [
