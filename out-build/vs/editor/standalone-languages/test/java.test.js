 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", 'assert', 'vs/editor/standalone-languages/java', 'vs/editor/standalone-languages/test/testUtil'], function (require, exports, assert, java_1, testUtil_1) {
    'use strict';
    testUtil_1.testTokenization('java', java_1.language, [
    ...
    suite('java', function () {
        test('word definition', function () {
            var wordDefinition = java_1.language.wordDefinition;
