 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", 'vs/editor/standalone-languages/cpp', 'vs/editor/standalone-languages/test/testUtil'], function (require, exports, cpp_1, testUtil_1) {
    'use strict';
    testUtil_1.testOnEnter('cpp', cpp_1.language, function (assertOnEnter) {
    ...
    testUtil_1.testTokenization('cpp', cpp_1.language, [
        // Keywords
        [{
