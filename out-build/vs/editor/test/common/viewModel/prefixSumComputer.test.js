define(["require", "exports", 'assert', 'vs/editor/common/viewModel/prefixSumComputer'], function (require, exports, assert, prefixSumComputer_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('Editor ViewModel - PrefixSumComputer', function () {
        test('PrefixSumComputer', function () {
            var indexOfResult;
            var psc = new prefixSumComputer_1.PrefixSumComputer([1, 1, 2, 1, 3]);
