define(["require", "exports", 'assert', 'vs/editor/common/editorCommon', 'vs/editor/common/viewLayout/viewLineRenderer'], function (require, exports, assert, editorCommon_1, viewLineRenderer_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('viewLineRenderer.renderLine', function () {
        function createPart(startIndex, type) {
            return new editorCommon_1.ViewLineToken(startIndex, type);
        }
        function assertCharacterReplacement(lineContent, tabSize, expected, expectedCharOffsetInPart) {
            var _actual = viewLineRenderer_1.renderLine(new viewLineRenderer_1.RenderLineInput(lineContent, tabSize, 0, -1, false, [createPart(0, '')]));
        ...
        function assertParts(lineContent, tabSize, parts, expected, expectedCharOffsetInPart) {
            var _actual = viewLineRenderer_1.renderLine(new viewLineRenderer_1.RenderLineInput(lineContent, tabSize, 0, -1, false, parts));
        ...
        test('overflow', function () {
            var _actual = viewLineRenderer_1.renderLine(new viewLineRenderer_1.RenderLineInput('Hello world!', 4, 10, 6, true, [
                createPart(0, '0'),
                createPart(1, '1'),
                createPart(2, '2'),
                createPart(3, '3'),
        ...
        test('typical line', function () {
            ...
            var _actual = viewLineRenderer_1.renderLine(new viewLineRenderer_1.RenderLineInput(lineText, 4, 10, -1, true, lineParts));
            assert.equal(_actual.output, '<span>' + expectedOutput + '</span>');
        ...
        test('issue #2255: Weird line rendering part 1', function () {
            ...
            var lineParts = [
                createPart(0, 'block body decl declaration meta method object ts'),
                createPart(3, 'block body decl declaration member meta method object ts'),
                createPart(15, 'block body decl declaration member meta method object ts'),
                createPart(21, 'delimiter paren typescript'),
                createPart(22, 'block body decl declaration member meta method object ts'),
                createPart(43, 'block body comparison decl declaration keyword member meta method object operator ts'),
                createPart(45, 'block body comparison decl declaration keyword member meta method object operator ts'),
                createPart(46, 'block body decl declaration member meta method object ts'),
                createPart(66, 'delimiter paren typescript'),
                createPart(67, 'block body decl declaration meta method object ts'),
            ];
            var expectedOutput = [
            ...
            var expectedOffsets = expectedOffsetsArr.reduce(function (prev, curr) { return prev.concat(curr); }, []);
            var _actual = viewLineRenderer_1.renderLine(new viewLineRenderer_1.RenderLineInput(lineText, 4, 10, -1, false, lineParts));
            assert.equal(_actual.output, '<span>' + expectedOutput + '</span>');
            assert.deepEqual(_actual.charOffsetInPart, expectedOffsets);
        });
        test('issue #2255: Weird line rendering part 2', function () {
            ...
            var lineParts = [
                createPart(0, 'block body decl declaration meta method object ts'),
                createPart(4, 'block body decl declaration member meta method object ts'),
                createPart(16, 'block body decl declaration member meta method object ts'),
                createPart(22, 'delimiter paren typescript'),
                createPart(23, 'block body decl declaration member meta method object ts'),
                createPart(44, 'block body comparison decl declaration keyword member meta method object operator ts'),
                createPart(46, 'block body comparison decl declaration keyword member meta method object operator ts'),
                createPart(47, 'block body decl declaration member meta method object ts'),
                createPart(67, 'delimiter paren typescript'),
                createPart(68, 'block body decl declaration meta method object ts'),
            ];
            var expectedOutput = [
                '<span class="token block body decl declaration meta method object ts">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>',
                '<span class="token block body decl declaration member meta method object ts">cursorStyle:</span>',
