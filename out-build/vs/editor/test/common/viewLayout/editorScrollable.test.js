define(["require", "exports", 'assert', 'vs/editor/common/viewLayout/editorScrollable'], function (require, exports, assert, editorScrollable_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('Editor ViewLayout - EditorScrollable', function () {
        ...
        test('EditorScrollable', function () {
            var scrollable = new editorScrollable_1.EditorScrollable();
