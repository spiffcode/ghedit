define(["require", "exports", 'assert', 'vs/editor/common/viewLayout/verticalObjects'], function (require, exports, assert, verticalObjects_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('Editor ViewLayout - VerticalObjects', function () {
        test('VerticalObjects 1', function () {
            var verticalObjects = new verticalObjects_1.VerticalObjects();
