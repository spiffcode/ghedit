 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", 'assert', 'vs/editor/common/editorCommon', 'vs/editor/common/model/mirrorModel'], function (require, exports, assert, editorCommon, mirrorModel_1) {
    "use strict";
    ...
    suite('Editor Model - MirrorModel', function () {
        var mirrorModel;
        setup(function () {
            mirrorModel = mirrorModel_1.createTestMirrorModelFromString('line1\nline2\nline3\nline4');
        });
        teardown(function () {
            mirrorModel.dispose();
            mirrorModel = null;
        ...
        test('get (all/unique) words', function () {
            var model = mirrorModel_1.createTestMirrorModelFromString('foo bar foo bar');
            ...
            model = mirrorModel_1.createTestMirrorModelFromString('foo bar\nfoo\nbar');
        ...
        test('word at/until pos', function () {
            ...
            var model = mirrorModel_1.createTestMirrorModelFromString('foo bar 1234 :";\'');
        ...
        test('words with ranges', function () {
            ...
            var model = mirrorModel_1.createTestMirrorModelFromString('foo bar\nfoo\nbar');
    ...
    suite('Editor Model - MirrorModel Eventing', function () {
        var mirrorModel;
        setup(function () {
            mirrorModel = mirrorModel_1.createTestMirrorModelFromString('line one\nline two\nline three\nline four');
        });
        teardown(function () {
            mirrorModel.dispose();
            mirrorModel = null;
