define(["require", "exports", 'assert', 'vs/editor/common/core/position', 'vs/editor/common/core/range', 'vs/editor/common/editorCommon', 'vs/editor/contrib/find/common/findModel', 'vs/editor/contrib/find/common/findState', 'vs/editor/test/common/mocks/mockCodeEditor'], function (require, exports, assert, position_1, range_1, editorCommon_1, findModel_1, findState_1, mockCodeEditor_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('FindModel', function () {
        ...
        findTest('find model reacts to position change', function (editor, cursor) {
            ...
            cursor.configuration.handlerDispatcher.trigger('mouse', editorCommon_1.Handler.MoveTo, {
        ...
        findTest('replaceAll two spaces with one space', function (editor, cursor) {
            ...
            findModel.replaceAll();
            assertFindState(editor, [9, 3, 9, 3], null, [
                [6, 1, 6, 3],
                [7, 1, 7, 3],
                [8, 1, 8, 3],
                [9, 1, 9, 3]
