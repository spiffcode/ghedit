define(["require", "exports", 'vs/base/common/strings', 'vs/editor/common/core/editOperation', 'vs/editor/common/core/position', 'vs/editor/common/core/range', 'vs/editor/common/core/selection', './blockCommentCommand'], function (require, exports, strings, editOperation_1, position_1, range_1, selection_1, blockCommentCommand_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var LineCommentCommand = (function () {
        ...
        LineCommentCommand.prototype._executeBlockComment = function (model, builder, s) {
            var richEditSupport = model.getModeAtPosition(s.startLineNumber, s.startColumn).richEditSupport;
            var config = richEditSupport ? richEditSupport.comments : null;
