...
define(["require", "exports", 'vs/base/common/async', 'vs/base/common/errors', 'vs/base/common/lifecycle', 'vs/base/common/severity', 'vs/base/common/strings', 'vs/base/common/winjs.base', 'vs/base/browser/dom', 'vs/platform/configuration/common/configuration', 'vs/platform/keybinding/common/keybindingService', 'vs/platform/message/common/message', 'vs/editor/common/core/range', 'vs/editor/common/editorCommon', 'vs/editor/common/modes', 'vs/editor/common/services/modelService', 'vs/editor/browser/editorBrowser', 'vs/editor/browser/editorBrowserExtensions', '../common/codelens', 'vs/css!./codelens'], function (require, exports, async_1, errors_1, lifecycle_1, severity_1, strings_1, winjs_base_1, dom, configuration_1, keybindingService_1, message_1, range_1, editorCommon, modes_1, modelService_1, editorBrowser, editorBrowserExtensions_1, codelens_1) {
    'use strict';
    ...
    var CodeLensContribution = (function () {
        function CodeLensContribution(editor, modelService, configurationService, keybindingService, messageService) {
            ...
            this._globalToDispose.push(modes_1.CodeLensRegistry.onDidChange(this.onModelChange, this));
            this.onModelChange();
        }
        ...
        CodeLensContribution.prototype.onModelChange = function () {
            ...
            if (!modes_1.CodeLensRegistry.has(model)) {
                return;
            }
