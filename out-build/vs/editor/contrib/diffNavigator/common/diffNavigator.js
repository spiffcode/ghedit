...
define(["require", "exports", 'vs/base/common/assert', 'vs/base/common/eventEmitter', 'vs/base/common/objects', 'vs/editor/common/core/range', 'vs/editor/common/editorCommon'], function (require, exports, assert, eventEmitter_1, objects, range_1, editorCommon_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var DiffNavigator = (function (_super) {
        ...
        function DiffNavigator(editor, options) {
            ...
            this.toUnbind.push(this.editor.addListener(editorCommon_1.EventType.Disposed, function () { return _this.dispose(); }));
            this.toUnbind.push(this.editor.addListener(editorCommon_1.EventType.DiffUpdated, function () { return _this.onDiffUpdated(); }));
            if (this.options.followsCaret) {
                this.toUnbind.push(this.editor.getModifiedEditor().addListener(editorCommon_1.EventType.CursorPositionChanged, function (e) {
            ...
            if (this.options.alwaysRevealFirst) {
                this.toUnbind.push(this.editor.getModifiedEditor().addListener(editorCommon_1.EventType.ModelChanged, function (e) {
