define(["require", "exports", 'vs/base/common/errors', 'vs/editor/common/controller/oneCursor', 'vs/editor/common/core/selection'], function (require, exports, errors_1, oneCursor_1, selection_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var CursorCollection = (function () {
        ...
        CursorCollection.prototype.getModeConfiguration = function () {
            ...
            var richEditSupport = this.model.getMode().richEditSupport;
            var electricChars;
