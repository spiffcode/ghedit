...
define(["require", "exports", 'assert', 'vs/base/common/uri', 'vs/workbench/api/node/extHostTypes', 'vs/base/common/platform'], function (require, exports, assert, uri_1, types, platform_1) {
    ...
    suite('ExtHostTypes', function () {
        ...
        test('toJSON & stringify', function () {
            ...
            assertToJSON(new types.Location(types.Uri.file('u.ts'), new types.Position(3, 4)), { uri: uri_1.default.parse('file:///u.ts').toJSON(), range: [{ line: 3, character: 4 }, { line: 3, character: 4 }] });
            assertToJSON(new types.Location(types.Uri.file('u.ts'), new types.Range(1, 2, 3, 4)), { uri: uri_1.default.parse('file:///u.ts').toJSON(), range: [{ line: 1, character: 2 }, { line: 3, character: 4 }] });
