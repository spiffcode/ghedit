...
define(["require", "exports", 'vs/base/common/winjs.base', 'vs/base/common/actions', 'vs/workbench/browser/actionBarRegistry', 'vs/base/common/types', 'vs/workbench/common/events', 'vs/platform/platform', 'vs/workbench/browser/panel', 'vs/workbench/common/editor', 'vs/platform/editor/common/editor', 'vs/platform/instantiation/common/descriptors'], function (require, exports, winjs_base_1, actions_1, actionBarRegistry_1, types, events_1, platform_1, panel_1, editor_1, editor_2, descriptors_1) {
    ...
    var BaseEditor = (function (_super) {
        ...
        BaseEditor.prototype.changePosition = function (position) {
            this._position = position;
            this.emit(events_1.EventType.EDITOR_POSITION_CHANGED, new events_1.EditorEvent(this, this.getId(), this.input, this.options, this.position));
        };
