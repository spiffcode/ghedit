define(["require", "exports", 'vs/editor/test/common/modesUtil', 'vs/languages/typescript/common/tokenization', 'vs/editor/test/common/mocks/mockMode', 'vs/languages/typescript/common/mode'], function (require, exports, modesUtil, tokenization_1, mockMode_1, mode_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('TS/JS - syntax highlighting', function () {
        var tokenizationSupport = tokenization_1.createTokenizationSupport(new mockMode_1.MockMode('javascript'), tokenization_1.Language.EcmaScript5);
        var assertOnEnter = modesUtil.createOnEnterAsserter('javascript', mode_1.createRichEditSupport('javascript'));
