...
define(["require", "exports", 'vs/base/common/objects', 'vs/base/common/errors', 'vs/editor/common/modes/abstractState', 'vs/languages/razor/common/vsxmlTokenTypes'], function (require, exports, objects, errors, abstractState_1, vsxmlTokenTypes) {
    'use strict';
    var separators = '<>"=/';
    var whitespace = '\t ';
