...
define(["require", "exports", 'vs/platform/platform', 'vs/workbench/browser/viewlet', 'vs/platform/configuration/common/configurationRegistry', 'vs/nls', 'vs/workbench/parts/files/common/files', 'vs/platform/actions/common/actions', 'vs/base/browser/ui/actionbar/actionbar', 'vs/workbench/browser/actionBarRegistry', 'vs/workbench/common/actionRegistry', 'vs/workbench/browser/quickopen', 'vs/workbench/browser/actions/quickOpenAction', 'vs/platform/keybinding/common/keybindingsRegistry', 'vs/platform/instantiation/common/instantiation', 'vs/platform/instantiation/common/descriptors', 'vs/platform/workspace/common/workspace', 'vs/platform/keybinding/common/keybindingService', 'vs/workbench/services/quickopen/common/quickOpenService', 'vs/workbench/services/viewlet/common/viewletService', 'vs/workbench/services/editor/common/editorService', 'vs/base/common/keyCodes', 'vs/css!vs/workbench/parts/search/browser/media/search.contribution'], function (require, exports, platform_1, viewlet_1, configurationRegistry_1, nls, files_1, actions_1, actionbar_1, actionBarRegistry_1, actionRegistry_1, quickopen_1, quickOpenAction_1, keybindingsRegistry_1, instantiation_1, descriptors_1, workspace_1, keybindingService_1, quickOpenService_1, viewletService_1, editorService_1, keyCodes_1) {
    ...
    var ExplorerViewerActionContributor = (function (_super) {
        ...
        ExplorerViewerActionContributor.prototype.getSecondaryActions = function (context) {
            ...
            if (this.hasSecondaryActions(context)) {
                ...
                var action = new actions_1.DeferredAction(this._instantiationService, 
                // new AsyncDescriptor('vs/workbench/parts/search/browser/searchViewlet', 'FindInFolderAction', fileResource.resource),
                new descriptors_1.AsyncDescriptor('forked/searchViewlet', 'FindInFolderAction', fileResource.resource), 'workbench.search.action.findInFolder', nls.localize('findInFolder', "Find in Folder"));
                action.order = 55;
                actions.push(action);
    ...
    // Register Viewlet
    platform_1.Registry.as(viewlet_1.Extensions.Viewlets).registerViewlet(new viewlet_1.ViewletDescriptor(
    //'vs/workbench/parts/search/browser/searchViewlet',
    'forked/searchViewlet', 'SearchViewlet', exports.VIEWLET_ID, nls.localize('name', "Search"), 'search', 10));
