...
export class TextDiffEditor extends BaseTextEditor {
	...
	constructor(
		...
		super(TextDiffEditor.ID, telemetryService, instantiationService, contextService, storageService, messageService, configurationService, eventService, editorService, themeService, environmentService);
