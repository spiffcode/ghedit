...
// DESKTOP: import { IProcessEnvironment, IEnvService, EnvService } from 'vs/code/electron-main/env';
import { IProcessEnvironment, IEnvService } from 'vs/code/electron-main/env';
...
function start(): void {
	...
	// DESKTOP: services.set(IEnvService, new SyncDescriptor(EnvService));
