...
// Forked from vs/workbench/parts/search/browser/searchViewlet.ts
...
import {FindInput} from 'forked/findInput'; // Was 'vs/base/browser/ui/findinput/findInput'
...
import { SearchRenderer, SearchDataSource, SearchSorter, SearchController, SearchAccessibilityProvider, SearchFilter } from 'forked/searchResultsView';
// import { SearchWidget } from 'vs/workbench/parts/search/browser/searchWidget';
import { SearchWidget } from 'forked/searchWidget';
import { RefreshAction, CollapseAllAction, ClearSearchResultsAction, ConfigureGlobalExclusionsAction } from 'forked/searchActions';
