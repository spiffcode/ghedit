...
// Forked from vs/workbench/browser/parts/editor/editor.contribution.ts
...
import {ChangeEncodingAction, ChangeEOLAction, ChangeModeAction, EditorStatus} from 'forked/editorStatus';
